...
const Footer = () => {
  return (
    <div className='footer-card'>  
        ...
        <ul className='unorder-card'> 
            <li className='li-card'>Insurance Processing Charges(onr time change) will be billed in addition to the above charges for every patient admission.</li>
            <li className='li-card'>In case a higher category room(beyond eligibility) is opted for. pro rata charges will be levied to you for all services availed.</li>
            <li className='li-card'>List of Non-Medical Expenses & Insurance Checklist have been provided to you.</li>
